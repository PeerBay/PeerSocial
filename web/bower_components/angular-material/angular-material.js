...
function VirtualRepeatContainerController($$rAF, $scope, $element, $attrs) {
  ...
  //notify
  this.notifier = this.scroller.getElementsByClassName('md-notifier')[0]
...
VirtualRepeatContainerController.prototype.register = function(repeaterCtrl) {
  ...
  // notify
  angular.element(this.notifier)
      .on('click', angular.bind(this, function(ev){console.log("notifier clicked",ev)}));
